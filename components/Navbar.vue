    ...
    <div class="container mx-auto px-4">
      <div class="flex items-center justify-between py-4">
        <div>
          ...
          <h1 class="text-white text-3xl font-semibold">SOLO-LEVELING</h1>
        </div>

        <div class="hidden sm:flex sm:items-center">
          <a href="#" class="text-gray-300 text-md font-semibold cursor-pointer hover:text-[#FC82FE]  mr-4">Contact</a>
          <a href="#" class="text-gray-300 text-md font-semibold cursor-pointer hover:text-[#FC82FE]  mr-4">About</a>
          <a href="#" class="text-gray-300 text-md font-semibold cursor-pointer hover:text-[#FC82FE]  mr-4">Service</a>
        </div>

        <div class="hidden sm:flex sm:items-center " style="z-index:1;">
          <a href="#" class="text-gray-300 text-md font-semibold hover:text-[#FC82FE] mr-4 cursor-pointer"><i class="fab fa-facebook-square"></i> FACEBOOK</a>
          <a href="#" class="text-gray-300 text-md font-semibold hover:text-[#FC82FE] cursor-pointer"><i class="fab fa-instagram"></i> Instagram</a>
        </div>

        <div class="sm:hidden cursor-pointer">
          <a @click="Mobilemenu = !Mobilemenu"> 
              <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-7 text-gray-200" viewBox="0 0 24 24">
      ...
      <div class="block sm:hidden bg-tranparent border-t-2 py-2 mobilemenu" v-show="Mobilemenu" style="z-index:1">
        <div class="flex flex-col">
          <a href="#" class="text-gray-300 text-md font-semibold cursor-pointer hover:text-[#FC82FE]  mr-4 my-2">Contact</a>
          <a href="#" class="text-gray-300 text-md font-semibold cursor-pointer hover:text-[#FC82FE]  mr-4 my-2">About</a>
          <a href="#" class="text-gray-300 text-md font-semibold cursor-pointer hover:text-[#FC82FE]  mr-4 my-2">Service</a>
          <div class="flex justify-left items-center border-t-2 pt-2">
            <a href="#" class="text-gray-300 text-md font-semibold hover:text-[#FC82FE] mr-4 cursor-pointer"><i class="fab fa-facebook-square"></i> FACEBOOK</a>
          <a href="#" class="text-gray-300 text-md font-semibold hover:text-[#FC82FE] cursor-pointer"><i class="fab fa-instagram"></i> Instagram</a>
          </div>
        </div>
